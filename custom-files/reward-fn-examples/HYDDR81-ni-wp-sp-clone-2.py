...
#####SPEED
    ...
    if params["closest_waypoints"][1] in fast:
        ...
        if params["speed"] > 1 and params["speed"] <= 2.75:
...
# params = {"speed":1,"steering_angle":90,"steps":10,"distance_from_center":90,"heading":8,"waypoints":[[1,2],[1,2],[1,2]],"closest_waypoints":[0,0],"track_width":10,"all_wheels_on_track":True,"is_left_of_center":True,"progress":10}
